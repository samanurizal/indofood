...
if (isset($fullUrl)) {
    ...
    $urlAsli = str_replace("query.php", "", $baseUrl);
    ...
    fwrite($sitemapFile, '<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    foreach ($fileLines as $index => $judul) {
        $sitemapLink = $urlAsli . '?resmi=' . urlencode($judul);
